...
<amp-img alt='<?php echo $judul; ?>' height='372' layout='responsive' src='/<?php echo sanitize_title($images);?>.jpg' width='728'></amp-img>
</div>
</div>
</div>
<ul>       <li><?php echo $judul; ?> Promo</li>
...
<h3>Booking Promo <?php echo spinText("{50%|60%|70%|75%|80%|85%|90%}");?> Off <?php echo $judul; ?></h3><br>
<?php
echo '';
  $firstx = ($nav - 1) * 10;
  $firstx = $firstx + 1; 
...
endforeach;
	?>
<h3>Smiliar Hotels <?php echo $judul; ?></h3>
<?php agclist();?>
<?php agclist();?>
<?php agclist();?>
<div class='clear'></div>
